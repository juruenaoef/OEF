...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Overland2',
										'page_location': '/#overland2',
									});
								},
							],
						},
					...
					'itinerario': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Itinerario',
										'page_location': '/#itinerario',
									});
								},
							],
						},
					...
					'politicasdeviaje': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Politicasdeviaje',
										'page_location': '/#politicasdeviaje',
									});
								},
							],
						},
	...
	// Slideshow: slideshow02.
		(function() {
			...
			new slideshowBackground('slideshow02', {
				...
				images: [
					{
						src: 'assets/images/slideshow02-55e384f4.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿Cuantos kilómetros se recorren? Rta: Aprox. 700 kilometros',
					},
					{
						src: 'assets/images/slideshow02-8e7ce478.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿Qué necesito para asistir? Rta.: UN VEHÍCULO CON TRACCION EN LAS 4 RUEDAS Y ALTURA LIBRE AL PISO DE MÍNIMO 23 CM',
					},
					{
						src: 'assets/images/slideshow02-f628e3f6.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿cUANTOS vEHICULOS SON? Rta. : nUESTRA TRAVESÍA ES PARA MÁXÍMO 10 VEHICULOS',
					},
					{
						src: 'assets/images/slideshow02-243f8a8f.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: '¿QUÉ PASA SI ME ENTIERRO? Rta.: sIEMPRE CONTARÁS CON EL VEHÍCULO DE APOYO PARA SALIR DE CUALQUIER DIFICULTAD.',
					},
					{
						src: 'assets/images/slideshow02-8b6e91be.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿QUÉ PASA SI ME VARO? Rta.: ANTE CUALQUIER IMPREVISTO TE BRINDAREMOS ASISTENCIA MECÁNICA BÁSICA.',
					},
					{
						src: 'assets/images/slideshow02-38040ac5.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿pUEDEN IR nIÑOS? Rta.: cLARO QUE SÍ!, ES UNA EXPERIENCIA CON AMBIENTE FAMILIAR',
					},
					{
						src: 'assets/images/slideshow02-ce58755c.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿PUEDO LLEVAR MASCOTAS? RTA.: Claro que sí, son parte de la familia.',
					},
					{
						src: 'assets/images/slideshow02-d5c7a368.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿pUEDO aCAMPAR? Rta.: cLARO QUE SÍ, LLEVAS TU CARPA Y ARMAMOS UN BARRIO.',
					},
					{
						src: 'assets/images/slideshow02-62d63b7d.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: '¿Puedo cocinar? Rta.: PUEDES COCINAR Y TAMBIÉN COMPARTIR.',
					},
					{
						src: 'assets/images/slideshow02-5a9226ee.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'SOY DISCAPACITADO ¿pUEDO ASISTIR? hAY ALGUNOS RETOS QUE SORTEAR, PERO ¡¡EL QUE QUIERE, PUEDE!!',
					},
					{
						src: 'assets/images/slideshow02-737e0b89.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Somos una familia de 5 ¿hay descuentos? Rta.: cLARO QUE SÍ, para más de 3 personas escríbenos para obtener el tuyo.',
					},
				]
			});
	...
	// Slideshow: slideshow03.
		(function() {
			...
			new slideshowBackground('slideshow03', {
				...
				images: [
					{
						src: 'assets/images/slideshow03-91cd9b3a.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Guajira Perimetral',
					},
					{
						src: 'assets/images/slideshow03-be90148b.jpg',
						position: 'top',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					},
					{
						src: 'assets/images/slideshow03-88e846ef.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow03-9e21b000.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-18a23cea.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow01-5c27581c.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow01-ef865193.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow01-1de03b77.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow01-b7679b6b.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
					...
					{
						src: 'assets/images/slideshow01-5d910fc3.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Roadtrip - Alta Guajira',
	...
	// Buttons: buttons02.
		$('#buttons02 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				fbq('trackCustom', 'viewitinerario');
				gtag('event', 'Ver itinerario')
			}
		);
	...
	// Buttons: buttons07.
		$('#buttons07 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				fbq('trackCustom', 'viewplan', {plan: "Overland"});
				gtag('event', 'detalleplan');
			}
		);
		
		$('#buttons07 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				fbq('trackCustom', 'viewitinerario');
				gtag('event', 'Ver itinerario')
		...
		$('#buttons07 > li:nth-child(3) > a').addEventListener(
			'click',
			function(event) { 
				gtag('event', 'contactarunasesor');
			}
		);
	...
	// Buttons: buttons05.
		...
		$('#buttons05 > li:nth-child(2) > a').addEventListener(
			'click',
			function(event) { 
				gtag('event', 'contactarunasesor');
			}
	...
	// Links: links04.
		$('#links04 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				fbq('trackCustom', 'viewpolicy');
				gtag('event', 'verpoliticas');
			}
		);
